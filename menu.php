	...
	<?php 
		...
		?>
			...
			<div class="menudivLeft">
					...
					<img src="media/reg-background.png" alt="<?php echo $rows[0]['package_name'];?> Package" width="330px" height="310px">
			...
			<div class="menudivRight">
				...
				<img src="media/reg-background.png" alt="<?php echo $rows[1]['package_name'];?> Package" width="330px" height="310px">
			</div>
			
			<div class="menudivLeft">
				<img src="media/reg-background.png" alt="<?php echo $rows[2]['package_name'];?> Package" width="330px" height="310px">
				<div class="pkgInfoLeft">
			...
			<div class="menudivRight">
				...
				<img src="media/reg-background.png" alt="<?php echo $rows[3]['package_name'];?> Package"width="330px" height="310px">
			</div>
			
			<div class="menudivLeft">
			
				<img src="media/reg-background.png" alt="<?php echo $rows[4]['package_name'];?> Package" width="330px" height="310px">
